function Accordion() {
  return (
    <section className="w-full divide-y divide-slate-200 rounded-xl border border-slate-200 bg-white mt-5">
      <details className="group p-4" open>
        <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
          ...
          Kursunuzda sosial hesablar varmı?
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <p className="mt-4 text-slate-500">
          Bəli! Bizim texnologiya kursumuz Facebook, Discord, Reddit və digər
          bir çox sosial platformalarda mövcuddur. Sosial media hesablarımızı
          saytımızın alt bölməsində tapa bilərsiniz.
        </p>
      </details>
      <details className="group p-4">
        <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
          ...
          Dəstək komandası ilə necə əlaqə saxlaya bilərəm?
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="absolute right-0 top-1 h-4 w-4 shrink-0 stroke-slate-700 transition duration-300 group-open:rotate-45"
            fill="none"
        ...
        <p className="mt-4 text-slate-500">
          Dəstək komandamızla əlaqə saxlamaq üçün bizim Discord kanalımıza
          qoşula bilərsiniz. Sualınızı verdikdən sonra komanda üzvlərimizdən
          biri sizə ən qısa zamanda cavab verəcək.
        </p>
      </details>
      <details className="group p-4">
        <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
        ...
        <p className="mt-4 text-slate-500">
          Əlbəttə! Xəbər bülletenimiz vasitəsilə icmamıza qoşula bilərsiniz.
          Saytımızın hər səhifəsinin alt hissəsində xəbər bülletenimizə
          qeydiyyat bölməsini tapa bilərsiniz.
        </p>
      </details>
      <details className="group p-4">
        <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
        ...
        <p className="mt-4 text-slate-500">
          Bizimlə hər zaman sosial hesablarımız və info@texnoloji-kurs.com email
          ünvanı vasitəsilə əlaqə saxlaya bilərsiniz.
        </p>
      </details>
    </section>
  );
