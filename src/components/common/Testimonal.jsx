  ...
  return (
    <>
      ...
      <div className="overflow-hidden border rounded-2xl bg-white text-slate-500 shadow-2xl shadow-slate-200">
        <div className="relative p-6">
          <figure className="relative z-10">
            <blockquote className="p-6 text-lg leading-relaxed">
              <p>
                {`"Genc Tech kursu, mənim iştirak etdiyim ən yaxşı tədris proqramlarından biridir. Kursun dərsləri həm gözəl tərtib olunmuş, həm də asan anlaşılandır. İstifadəsi çox rahatdır və hər kəs üçün əlçatan olan materiallarla doludur. Burada əldə etdiyim biliklər mənim karyerama böyük töhfə verdi."`}
              </p>
            </blockquote>
              ...
              <div className="flex items-center gap-4 pt-4 text-sm text-emerald-500">
                <div className="flex flex-col gap-1">
                  ...
                  <cite className="not-italic">
                    <a href="http://www.microsoft.com">Full-stack Developer</a>
                  </cite>
                </div>
              </div>
            </figcaption>
        ...
        <div className="w-full h-max flex justify-end p-3">
          <button className="btn bg-yellow-500 hover:bg-yellow-400 transition duration-300 text-slate-50">
            Digər rəylər
          </button>
        </div>
      </div>
